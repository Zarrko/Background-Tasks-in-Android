...
import com.example.zack.hydrationreminder.sync.WaterReminderFirebaseJobService;
...
public class ReminderUtilities {
    ...
    // keep track whether job is started or not
    private static boolean sInitialized;

    // start job.
    // synchronized. (Once a time)
    // Firebase Job dispatcher support from API 9
